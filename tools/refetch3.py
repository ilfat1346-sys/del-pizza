#!/usr/bin/env python3
"""Третий раунд: combo-friends, shawarma-spicy, nuggets, honey-cake -> img/cand3/."""
import json
import os
import time
import urllib.parse
...
OUT = os.path.join(os.getcwd(), "img", "cand3")
...
TARGETS = {
    "combo-friends": (["pizzas on restaurant table", "several pizzas on wooden table", "pizza table party"], "c"),
    "shawarma-spicy": (["chicken shawarma sandwich", "durum kebab", "kebab sandwich closeup"], "c"),
    "nuggets": (["chicken nuggets with dipping sauce", "nuggets basket fried"], "c"),
    "honey-cake": (["medovik", "honey layer cake slice", "russian honey cake"], "c"),
}
